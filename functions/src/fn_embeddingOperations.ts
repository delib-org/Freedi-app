 ...
 */
export async function generateBulkEmbeddings(request: Request, response: Response): Promise<void> {
 ...
 */
export async function getEmbeddingStatus(request: Request, response: Response): Promise<void> {
	try {
 ...
 */
export async function regenerateEmbedding(request: Request, response: Response): Promise<void> {
	const startTime = Date.now();
 ...
 */
export async function deleteEmbedding(request: Request, response: Response): Promise<void> {
	try {
		const { statementId } = request.body;
 ...
 */
export async function testEmbeddingGeneration(request: Request, response: Response): Promise<void> {
	try {
		...
		const similarity = embeddingService.cosineSimilarity(result1.embedding, result2.embedding);
