...
=== Live-synth accuracy — llm-only-L2-gpt-5.6-luna-seed42 (en) ===
statements: 100   ground truth: 50 synths in 10 topics

ACCURACY  0.972  (excellent)    = 0.6·F1_synth + 0.4·F1_topic
...
--- direct accuracy: how many did it actually get right? ---
  ...
  CLUSTER 0.960   = share of each theme's statements sitting in a group that represents that theme, averaged over 10 themes
  COMBINED 0.984  = 0.6·synth(clean) + 0.4·cluster
  ...
  per theme:   gathered into groups that stand for the theme / its statements
    ...
    environment-and-waste    10/10  in  6 representing group(s); biggest group touching it: 10/14  score 1.000
    education                10/10  in  6 representing group(s); biggest group touching it: 10/10  score 1.000
    parks-and-green-space     6/10  in  6 representing group(s); biggest group touching it: 6/6  score 0.600
...
--- topic level (did the 5 synths of a theme group together?) ---
  pairwise      P=0.914  R=0.947  F1=0.930   ARI=0.923
...
```json
{
  "run": "llm-only-L2-gpt-5.6-luna-seed42",
  "language": "en",
  "statements": 100,
  "composite": 0.9720524017467249,
  "grade": "excellent",
  "direct": {
    "composite": 0.984,
    "synthRate": 1,
  ...
  "topic": {
    ...
    "f1": 0.9301310043668122,
    "predictedCount": 466,
    "truthCount": 450,
    "ari": 0.9230096237970253,
    "producedCount": 10,
    "expectedCount": 10
  },
  "coverage": {
