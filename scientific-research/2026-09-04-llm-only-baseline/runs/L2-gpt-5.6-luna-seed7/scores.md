...
=== Live-synth accuracy — llm-only-L2-gpt-5.6-luna-seed7 (en) ===
...
--- topic level (did the 5 synths of a theme group together?) ---
  pairwise      P=0.785  R=0.911  F1=0.844   ARI=0.827
...
```json
{
  "run": "llm-only-L2-gpt-5.6-luna-seed7",
  "language": "en",
  "statements": 100,
  "composite": 0.9374485596707819,
  "grade": "excellent",
  "direct": {
    "composite": 0.96,
    "synthRate": 1,
  ...
  "topic": {
    ...
    "f1": 0.8436213991769548,
    "predictedCount": 522,
    "truthCount": 450,
    "ari": 0.8266998341625207,
    "producedCount": 9,
    "expectedCount": 10
  },
  "coverage": {
