...
=== Live-synth accuracy — llm-only-L1-gpt-5.6-terra-seed1234 (en) ===
...
--- direct accuracy: how many did it actually get right? ---
  ...
  per theme:   gathered into groups that stand for the theme / its statements
    ...
    culture                   8/10  in  6 representing group(s); biggest group touching it: 8/10  score 0.800
...
--- topic level (did the 5 synths of a theme group together?) ---
  pairwise      P=0.736  R=0.867  F1=0.796   ARI=0.774
...
```json
{
  "run": "llm-only-L1-gpt-5.6-terra-seed1234",
  "language": "en",
  "statements": 100,
  "composite": 0.9183673469387754,
  "grade": "excellent",
  "direct": {
  ...
  "topic": {
    ...
    "f1": 0.7959183673469387,
    "predictedCount": 530,
    "truthCount": 450,
    "ari": 0.7736625514403292,
    "producedCount": 9,
    "expectedCount": 10
  },
  "coverage": {
