...
=== Live-synth accuracy — llm-only-L1-gpt-5.6-terra-seed42 (en) ===
statements: 100   ground truth: 50 synths in 10 topics

ACCURACY  0.955  (excellent)    = 0.6·F1_synth + 0.4·F1_topic
...
--- topic level (did the 5 synths of a theme group together?) ---
  pairwise      P=0.841  R=0.938  F1=0.887   ARI=0.875
...
```json
{
  "run": "llm-only-L1-gpt-5.6-terra-seed42",
  "language": "en",
  "statements": 100,
  "composite": 0.9546218487394957,
  "grade": "excellent",
  "direct": {
    "composite": 0.968,
    "synthRate": 1,
