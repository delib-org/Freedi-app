...
| `3-probe-sampling-convergence.pdf` | `../2026-07-24-delta-support-probe/delta-support-probe-method.md` | Embedded probe sampling for measuring convergence on leading proposals during live deliberative events |
