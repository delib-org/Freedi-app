...
The art is rendered by a second Vite HTML entry at `/prototypes/olive-hill/village.html`. It has real volumetric adult/child characters, simple face geometry, village buildings, olive trees, short walking paths, council benches and synthesized ambient audio. Character geometry is preliminary and is not production-quality rigged art. No generated portrait PNGs are required by this scene.
