...
The art is rendered by a second Vite HTML entry at `/prototypes/olive-hill/village.html`. It has six Blender-authored adult villagers with anatomical faces, diverse age/skin/costume choices, village buildings, olive trees, short walking paths, council benches and synthesized ambient audio. The GLBs load asynchronously with a visible partial-load error; their static geometry has a subtle idle turn. Editable Blender sources, CC0 anatomy provenance and offline inspection renders are retained under `prototypes/olive-hill/characters`. The characters are not skeleton-rigged or photorealistic scanned art. No generated portrait PNGs are required by this scene.
