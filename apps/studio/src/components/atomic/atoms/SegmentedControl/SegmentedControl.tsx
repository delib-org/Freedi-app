...
/**
 * SegmentedControl atom — thin wrapper over the shared `.segmented-control`
 * block (@freedi/shared-styles/atoms/_segmented-control.scss). Tablist
 * semantics: arrow keys move + select, roving tabindex.
 */
...
const SegmentedControl: FC<SegmentedControlProps> = ({
	...
	return (
		<div
			ref={tablistRef}
			role="tablist"
			aria-label={ariaLabel ?? t('View switcher')}
