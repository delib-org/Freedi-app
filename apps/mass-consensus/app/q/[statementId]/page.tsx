...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  try {
    ...
    return {
      title: `${question.statement} | Freedi Mass Consensus`,
      description: question.description || `Participate in this mass consensus: ${question.statement}`,
      openGraph: {
    ...
    return {
      title: 'Question Not Found | Freedi Mass Consensus',
    };
  }
}
