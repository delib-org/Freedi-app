...
/**
 * FairEvalCard Molecule - Mass Consensus
 *
			...
			{isAdmin && (
				<div className="fair-eval-card__actions">
					{isGoalReached ? (
						<button
							type="button"
							className="fair-eval-card__action-btn fair-eval-card__action-btn--accept"
						...
						<button
							type="button"
							className="fair-eval-card__action-btn fair-eval-card__action-btn--complete"
