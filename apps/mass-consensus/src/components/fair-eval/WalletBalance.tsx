...
/**
 * WalletBalance Atom - Mass Consensus
 *
...
const WalletBalance: React.FC<WalletBalanceProps> = ({
	...
	const displayBalance = Number.isFinite(balance)
		? Math.round(balance * 10) / 10
		: 0;
	...
	return (
		<span className={classes} role="status" aria-live="polite">
			...
			{!compact && <span className="wallet-balance__unit">{t('min')}</span>}
		</span>
	);
};
