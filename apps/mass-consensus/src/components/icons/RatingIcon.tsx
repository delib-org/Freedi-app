...
/**
 * SVG rating icons for the -1 to +1 evaluation scale.
 *
 * -1   = Thumb down with emphasis lines (strongly disagree)
 * -0.5 = Single thumb down (disagree)
 *  0   = Horizontal dash (neutral)
 * +0.5 = Single thumb up (agree)
 * +1   = Thumb up with emphasis lines (strongly agree)
 *
...
export default function RatingIcon({ rating, className }: RatingIconProps) {
  ...
  switch (rating) {
    case 1:
      // Strongly Agree: two full-size thumbs up with slight overlap
      return (
    ...
    case -1:
      // Strongly Disagree: two full-size thumbs down with slight overlap
      return (
        <svg {...svgProps} width="1.75em" viewBox="0 0 42 24">
          <g transform="scale(0.85)">
            <path d={THUMB_DOWN} />
