 ...
 * 1. Admin has set a defaultLanguage on the document
 ...
 *
 * This ensures document viewers see the admin's intended language
...
export function LanguageOverrideProvider({
  ...
  useEffect(() => {
    // 1. Admin has set a language preference for this document
