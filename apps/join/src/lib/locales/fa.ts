...
const fa: Record<string, string> = {
	...
	'mainHub.summary.title': 'خلاصه',
	'mainHub.summary.generatedAt': 'ایجاد شده {{date}}',
	'mainHub.summary.generate': 'ایجاد خلاصه با هوش مصنوعی',
	'mainHub.summary.regenerate': 'به‌روزرسانی خلاصه',
	'mainHub.summary.busy': 'در حال خلاصه‌سازی…',
	'mainHub.summary.edit': 'ویرایش',
