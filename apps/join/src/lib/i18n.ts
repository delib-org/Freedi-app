...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'facilitator.sort.help': 'Everyone sees suggestions in this order, including participants you bring with Follow me.',
    ...
    'facilitator.toggle.allowEvaluation': 'Allow evaluation',
    'facilitator.toggle.allowEvaluation.help': 'Lets people rate suggestions on a five-face scale; their choice is saved and counted toward the consensus score.',
  ...
  he: {
    ...
    'facilitator.toggle.allowEvaluation': 'אפשור הערכה',
    'facilitator.toggle.allowEvaluation.help': 'מאפשר למשתתפים לדרג הצעות בסולם של חמישה פרצופים; הבחירה נשמרת ומשפיעה על ציון ההסכמה.',
  ...
  ar: {
    ...
    'facilitator.sort.help': 'يرى الجميع الاقتراحات بهذا الترتيب، بمن فيهم المشاركون الذين تجلبهم بـ "اتبعني".',
    ...
    'facilitator.toggle.allowEvaluation': 'السماح بالتقييم',
    'facilitator.toggle.allowEvaluation.help': 'يسمح للمشاركين بتقييم الاقتراحات على مقياس من خمسة وجوه؛ يُحفظ اختيارهم ويُحتسب ضمن درجة التوافق.',
  ...
  de: {
    ...
    'facilitator.sort.help': 'Alle sehen die Vorschläge in dieser Reihenfolge, auch die Teilnehmenden, die Sie per „Folgt mir“ hierher holen.',
    ...
    'facilitator.toggle.allowEvaluation': 'Bewertung erlauben',
    'facilitator.toggle.allowEvaluation.help': 'Lässt Teilnehmende Vorschläge auf einer Fünf-Gesichter-Skala bewerten; die Auswahl wird gespeichert und in den Konsens eingerechnet.',
  ...
  es: {
    ...
    'facilitator.sort.help': 'Todos ven las sugerencias en este orden, incluidos los participantes que traes con «Síganme».',
    ...
    'facilitator.toggle.allowEvaluation': 'Permitir evaluación',
    'facilitator.toggle.allowEvaluation.help': 'Permite a los participantes valorar las sugerencias en una escala de cinco caras; su elección se guarda y se cuenta en el consenso.',
  ...
  nl: {
    ...
    'facilitator.sort.help': 'Iedereen ziet de suggesties in deze volgorde, inclusief deelnemers die je hierheen brengt met "Volg mij".',
    ...
    'facilitator.toggle.allowEvaluation': 'Beoordeling toestaan',
    'facilitator.toggle.allowEvaluation.help': 'Laat deelnemers suggesties beoordelen op een vijf-gezichten-schaal; de keuze wordt opgeslagen en meegeteld in de consensus.',
