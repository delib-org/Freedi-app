export async function debugServiceWorkers() {
    console.info('%c=== SERVICE WORKER DEBUG ===', 'color: purple; font-weight: bold; font-size: 16px');
...
return;
    ...
    console.info('%c=== END SERVICE WORKER DEBUG ===', 'color: purple; font-weight: bold; font-size: 16px');
}

// Add to window
if (typeof window !== 'undefined') {
    (window as { debugServiceWorkers?: typeof debugServiceWorkers }).debugServiceWorkers = debugServiceWorkers;
}
