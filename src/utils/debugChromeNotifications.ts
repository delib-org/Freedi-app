...
export async function debugChromeNotifications() {
    console.info('%c=== CHROME NOTIFICATIONS DEBUG ===', 'color: red; font-weight: bold; font-size: 16px');
...
if (typeof window !== 'undefined') {
    (window as { debugChromeNotifications?: typeof debugChromeNotifications }).debugChromeNotifications = debugChromeNotifications;
}