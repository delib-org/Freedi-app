...
const SubQuestionNode: FC<SubQuestionNodeProps> = ({
	...
	const userIsOnFollowedPage =
		followMePath && pathname.startsWith(followMePath.split('/').slice(0, 3).join('/'));
	...
	const isFollowedStatement =
		followMeStatementId && statement.statementId === followMeStatementId && !userIsOnFollowedPage;
