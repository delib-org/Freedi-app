								...
								<div className={styles.categoryContent}>
										...
										<>
											...
											{settings.hasChat !== false && (
												<ToggleSwitch
													...
													description={t(
														'Display the collapsible chat panel alongside the main content',
													)}
													icon={MessageCircle}
												/>
											)}
											...
											<ToggleSwitch
												...
												onChange={(checked) =>
													handleSettingChange('enableSubQuestionsMap', checked)
												}
											...
											<div className={styles.evaluationTypeSection}>
												...
												<div className={styles.evaluationCards}>
													<EvaluationCard
														...
														onClick={() =>
															handleSettingChange('evaluationType', evaluationType.range)
														}
													/>
													<EvaluationCard
														...
														isSelected={
															(settings.evaluationType ?? evaluationType.range) ===
															evaluationType.singleLike
														}
														onClick={() =>
															handleSettingChange('evaluationType', evaluationType.singleLike)
														}
													/>
												</div>
											</div>
											...
											{statement.statementType === StatementType.question && (
												<>
													...
													<ToggleSwitch
														...
														onChange={(checked) =>
															handleSettingChange('enableMultiSuggestionDetection', checked)
														}
														label={t('Multi-Suggestion Detection')}
														description={t(
															'Detect when users submit multiple ideas and offer to split them',
														)}
														icon={Scissors}
														badge="new"
													/>
									...
									{category.id === 'dataExport' && (
										<div className={styles.dataExportSection}>
											...
											<p className={styles.sectionDescription}>
												{t(
													'Download this statement and its direct sub-statements with full metadata',
												)}
											</p>
											...
											<p className={styles.exportInfo}>
												{t('Includes {{count}} sub-statements').replace(
													'{{count}}',
													String(subStatements.length),
												)}
											</p>
											...
											<p className={styles.exportInfo}>
												{t(
													'Includes evaluation counts, demographic breakdowns, and anonymized data',
												)}
											</p>
												...
												>
													{recalculateResult.success
														? t('Processed {{processed}} options, fixed {{fixed}} inconsistencies')
																.replace(
																	'{{processed}}',
																	String(recalculateResult.statementsProcessed),
																)
