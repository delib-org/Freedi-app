...
import { MassConsensusPageUrls, QuestionType } from '@/types/enums';
...
const QuestionSelector: FC = () => {
	...
	return (
		<>
			<select onChange={handleChangeQuestionType} className={styles.questionSelector} defaultValue={statement?.questionSettings?.questionType ?? QuestionType.multiStage}>
