...
**Status:** planned, not started. Prerequisite Phase 0 is independently justified by benchmark data and should ship first regardless of the hierarchy decision.
